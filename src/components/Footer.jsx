...
const Footer = () => {
    return (
        <>
            {/* 1. FAQs — existing design */}
            <FaqsAccordion />

            {/* 2. Mobile App Download */}
            <section style={{ backgroundColor: '#13110f', padding: '80px 20px', color: '#FFF', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
                <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
                    <h2 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '42px', fontWeight: 800, margin: '0 0 40px', lineHeight: 1.2 }}>
                        Also available to<br />download on both
                    </h2>
                    <div style={{ display: 'flex', justifyContent: 'center', gap: '20px', flexWrap: 'wrap' }}>
                        <a
                            href="https://play.google.com/store/apps/details?id=com.vesti.app&pli=1"
                            target="_blank" rel="noreferrer"
                            style={{ background: '#FFF', color: '#13110f', borderRadius: '10px', padding: '10px 16px', display: 'flex', alignItems: 'center', gap: '12px', textDecoration: 'none', transition: 'all 0.3s' }}
                        ...
                        <a
                            href="https://apps.apple.com/ca/app/vesti-move-abroad-pay-bills/id1564444402"
                            target="_blank" rel="noreferrer"
                            style={{ background: '#FFF', color: '#13110f', borderRadius: '10px', padding: '10px 16px', display: 'flex', alignItems: 'center', gap: '12px', textDecoration: 'none', transition: 'all 0.3s' }}
                            onMouseOver={e => e.currentTarget.style.transform = 'translateY(-3px)'}
                            onMouseOut={e => e.currentTarget.style.transform = 'translateY(0)'}
            ...
            {/* 3. Vesti Footer Links */}
            <footer className="footer" style={{ backgroundColor: '#13110f', color: '#FFF', padding: '60px 0 40px', fontFamily: "'Inter', sans-serif", borderTop: '1px solid rgba(255,255,255,0.07)' }}>
                <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
                    ...
                    <div style={{ marginTop: '48px', paddingTop: '24px', borderTop: '1px solid rgba(255,255,255,0.08)', textAlign: 'center' }}>
                        <p style={{ fontSize: '13px', color: '#555', margin: 0 }}>
                            © {new Date().getFullYear()} Vesti Migration OS. All rights reserved.
                        </p>
                    </div>
                </div>
            </footer>
