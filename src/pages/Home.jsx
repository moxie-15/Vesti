        ...
        <div style={{ backgroundColor: '#f9f5f0' }}>
            ...
            <section className="pathways-section" style={{ backgroundColor: '#FFFFFF', padding: '80px 50px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '25px', maxWidth: '1200px', margin: '0 auto' }}>
                    {[
                        { name: 'United States', id: 'usa', flag: 'us', desc: 'Explore top pathways like the O-1A, EB-1A, or NIW for extraordinary talent and professionals.', img: 'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
                        { name: 'Australia', id: 'australia', flag: 'au', desc: 'Unlock endless opportunities Down Under with skilled migration and regional visas.', img: 'https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
                        { name: 'Canada', id: 'canada', flag: 'ca', desc: 'Fast-track permanent residency via Express Entry or Provincial Nominee Programs.', img: 'https://images.unsplash.com/photo-1517935706615-2717063c2225?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
                        { name: 'New Zealand', id: 'new-zealand', flag: 'nz', desc: 'Explore the Magic of Aotearoa with seamless Visitor, Student, or Work Visa pathways.', img: 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
                        { name: 'France', id: 'france', flag: 'fr', desc: 'Experience the heart of Europe with seamless Visa pathways for tech talent and innovators.', img: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
                        { name: 'Spain', id: 'spain', flag: 'es', desc: 'Unlock opportunities in the vibrant Spanish economy with Digital Nomad and Golden Visas.', img: 'https://images.unsplash.com/photo-1543783207-ec64e4d95325?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
                    ].map((country, idx) => (
                        <Link key={idx} to={`/countries/${country.id}`} onMouseOut={() => handleMouseOut(`country${idx}`)} onMouseOver={() => handleMouseOver(`country${idx}`)} style={{ background: '#FFFFFF', border: '1px solid #f9f5f0', borderRadius: '20px', overflow: 'hidden', transition: 'transform 0.2s, box-shadow 0.2s', cursor: 'pointer', display: 'flex', flexDirection: 'column', height: '100%', boxShadow: hoverStates[`country${idx}`] ? '0 15px 30px rgba(0,0,0,0.1)' : '0 4px 15px rgba(0,0,0,0.05)', transform: hoverStates[`country${idx}`] ? 'translateY(-5px)' : 'translateY(0)', textDecoration: 'none' }}>
