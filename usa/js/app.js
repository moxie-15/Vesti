/* ==========================================================================
   Australia Vesti JavaScript Logic
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const pathwaysData = {
        general_visitor: {
            ...
            badgeClass: "gold",
            desc: "For individuals looking to explore the beautiful landscapes of Australia, visit friends and family, or enjoy amateur sports and adventure.",
        ...
        group_visitor: {
            ...
            badge: "Group Travel",
            badgeClass: "purple",
            desc: "Ideal for organized tour groups traveling to Australia for the same purpose and with the same itinerary.",
        ...
        business_visitor: {
            ...
            badgeClass: "green",
            desc: "For professionals needing to visit Australia for short-term business activities such as meetings, conferences, or trade negotiations.",
            processingTime: "Expedited Processing",
            requirements: [
                "Purpose of visit must be strictly business-related.",
                "Cannot be employed by a Australia company.",
        ...
        family_visitor: {
            ...
            badgeClass: "gold",
            desc: "Designed for individuals visiting a partner, spouse, or immediate family members who are Australia citizens or residents.",
    ...
    */
    ...
    const generateBlueprint = () => {
            ...
            document.getElementById('res-city-target').innerText = city === 'Not Sure' ? 'Australia' : city;
            ...
            if (milestoneTitle1 && milestoneTitle2 && milestoneTitle3 && milestoneTitle4) {
                if (timeline.includes('0-3 Months') || timeline.includes('Immediately')) {
                    ...
                    milestoneTitle2.innerText = 'Open Vesti AU Global Wallet (Week 2)';
                    ...
                    milestoneTitle2.innerText = 'Open Vesti AU Global Wallet (Month 3)';
                    ...
                    milestoneTitle2.innerText = 'Open Vesti AU Global Wallet (Months 4-5)';
                    ...
                    milestoneTitle2.innerText = 'Open Vesti AU Global Wallet (Months 7-9)';
            ...
            if (pathway.includes('general_visitor')) {
                resOccupationText.innerHTML = `As a General Visitor, prepare a robust travel itinerary, secure hotel bookings, and gather evidence of ties to your home country (such as family, employment, or property) to show intent to return. Vesti can help you set up an AUD Wallet.`;
            } else if (pathway.includes('business_visitor')) {
                resOccupationText.innerHTML = `As a Business Visitor, your activities must be strictly corporate (meetings, negotiations, or conferences). Gather an official invitation letter from the AU host company and a company support letter.`;
            } else if (pathway.includes('family_visitor')) {
                resOccupationText.innerHTML = `For a Family or Partner Visitor Visa, compile relationship proof, sponsor invitation letters, and sponsor financial documents. Vesti can assist you in setting up AUD wallets for independent travel funds.`;
            ...
            if (pathway.includes('family_visitor')) {
                resPofText.innerHTML = `For Family/Partner Visas, your sponsor can guarantee your maintenance and accommodation. Vesti can help you open an AUD account pre-arrival for independent financial flexibility.`;
            } else {
                resPofText.innerHTML = `Immigration Australia requires visitors to show proof of sufficient funds to support themselves (minimum $1,000 AUD per month of stay, or $400 AUD if accommodation is already prepaid). Use Vesti's certified pre-arrival Proof of Funds Certificate or wallet balance statement to satisfy this requirement seamlessly.`;
            }
            ...
            if (loanInterested) {
                ...
                let loanAmt = "$6,000 AUD";
                if (savings.includes('< $5k')) loanAmt = "$3,000 AUD";
                else if (savings.includes('$5k - $15k')) loanAmt = "$6,000 AUD";
                else if (savings.includes('$15k - $30k')) loanAmt = "$10,000 AUD";
                else loanAmt = "$15,000 AUD";
        ...
        eligForm.addEventListener('submit', (e) => {
            ...
            successOverlay.innerHTML = `
                <div style="background:#fff;border-radius:24px;padding:48px 40px;max-width:420px;width:90%;text-align:center;box-shadow:0 25px 60px rgba(0,0,0,0.3);animation:scaleUp 0.35s ease;">
                    <div style="width:72px;height:72px;border-radius:50%;background:rgba(98,148,59,0.12);border:2.5px solid #62943B;display:flex;align-items:center;justify-content:center;margin:0 auto 20px;">
                        <svg width="36" height="36" fill="none" stroke="#62943B" stroke-width="3" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                    </div>
                    <h2 style="font-family:'Outfit',sans-serif;font-size:24px;font-weight:700;color:#060E42;margin:0 0 10px;">Details Submitted Successfully!</h2>
                    ...
                    <button onclick="this.closest('#details-submitted-overlay').remove();" style="background:#62943B;color:#fff;border:none;padding:14px 40px;border-radius:12px;font-size:15px;font-weight:600;cursor:pointer;transition:background 0.2s;font-family:'Outfit',sans-serif;" onmouseover="this.style.background='#4e8236'" onmouseout="this.style.background='#62943B'">Done</button>
                </div>
            `;
