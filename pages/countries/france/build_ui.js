    ...
    <section class="py-16 bg-white" id="visa-services">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-[#13110f] mb-2 uppercase" style="font-family: 'Outfit', sans-serif;">Our Services</h2>
                <div class="h-1 w-16 bg-[#8BC34A] mx-auto"></div>
            </div>
            
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <!-- Business Visa -->
                <div class="bg-white p-8 rounded-sm shadow-lg border border-gray-100 hover:shadow-xl transition flex flex-col items-center text-center group hover:bg-[#13110f] hover:text-white">
                    <i data-lucide="briefcase" class="w-12 h-12 text-[#13110f] group-hover:text-white mb-4"></i>
                ...
                <!-- Work Visa -->
                <div class="bg-[#13110f] text-white p-8 rounded-sm shadow-lg border border-[#13110f] hover:shadow-xl transition flex flex-col items-center text-center group">
                ...
                <!-- Tourist Visa -->
                <div class="bg-white p-8 rounded-sm shadow-lg border border-gray-100 hover:shadow-xl transition flex flex-col items-center text-center group hover:bg-[#13110f] hover:text-white">
                    <i data-lucide="plane" class="w-12 h-12 text-[#13110f] group-hover:text-white mb-4"></i>
                ...
                <!-- Student Visa -->
                <div class="bg-white p-8 rounded-sm shadow-lg border border-gray-100 hover:shadow-xl transition flex flex-col items-center text-center group hover:bg-[#13110f] hover:text-white">
                    <i data-lucide="graduation-cap" class="w-12 h-12 text-[#13110f] group-hover:text-white mb-4"></i>
