...
htmlContent = htmlContent.replace(/background-color:\s*#060E42/g, 'background: linear-gradient(135deg, #004d40 0%, #00843D 100%)');
...
if (fs.existsSync(cssPath)) {
    ...
    cssContent = cssContent.replace(/#060E42/g, '#00843D'); // Deep Navy -> Outback Green
